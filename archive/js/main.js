    ...
    init: function () {
      ...
      el.addEventListener('raycaster-intersection', (evt) => {
        ...
        if (this.target_el.classList.contains('first-end')) {
          ...
          quiz1.setAttribute('material', { src: '#q-seki1', normalMap: '#q-seki1-NRM' });
          ...
          quiz2.setAttribute('material', { src: '#q-seki2', normalMap: '#q-seki2-NRM' });
          ...
          quiz3.setAttribute('material', { src: '#q-seki3', normalMap: '#q-seki3-NRM' });
          ...
          quiz4.setAttribute('material', { src: '#q-mon1', normalMap: '#q-mon1-NRM' });
          ...
          quiz5.setAttribute('material', { src: '#q-mon2', normalMap: '#q-mon2-NRM' });
          ...
          quiz6.setAttribute('material', { src: '#q-mon3', normalMap: '#q-mon3-NRM' });
          ...
          quiz7.setAttribute('material', { src: '#q-saku1', normalMap: '#q-saku1-NRM' });
          ...
          quiz8.setAttribute('material', { src: '#q-saku2', normalMap: '#q-saku2-NRM' });
          ...
          quiz9.setAttribute('material', { src: '#q-saku3', normalMap: '#q-saku3-NRM' });
          ...
          quiz10.setAttribute('material', { src: '#q-kan1', normalMap: '#q-kan1-NRM' });
          ...
          quiz11.setAttribute('material', { src: '#q-kan2', normalMap: '#q-kan2-NRM' });
          ...
          quiz12.setAttribute('material', { src: '#q-kan3', normalMap: '#q-kan3-NRM' });
